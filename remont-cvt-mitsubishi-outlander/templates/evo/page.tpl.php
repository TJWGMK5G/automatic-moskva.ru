    ...
    <header class="header">
      <div class="container">
        <div class="header-content">
          ...
          <div class="header-content-list">
            ...
            <ul class="burger-list-menu list-menu">
              ...
              <li><a href="http://motor-moskva.ru">Ремонт ДВС</a></li>
            </ul>
        ...
        <div class="main-content-info">
          <div class="main-content-info-title">Ремонт Вариаторов Mitsubishi Outlander </div>
          <div class="row">
...
-->
                ...
                <div class="main-content-info-display-bottom">
                  ...
                  <a class="applechat"
                    onclick="yaCounter23396941.reachGoal('social'); ga('send', 'event', 'request', 'social');" href="https://bcrw.apple.com/sms:open?service=iMessage&recipient=urn:biz:5e6cadc4-da68-451c-b6e9-f6eaac913b48" target="_blank"><img
                      alt="Ремонт Вариаторов Mitsubishi Outlander" src="../templates/evo/images/Icon/ime.png" /></a>
                </div>
     ...
     <div class="main-content-info-title">Сеть автосервисов по ремонту Вариаторов Mitsubishi Outlander </div>
      <div class="main-info">
        <div class="container">
              ...
              <div class="col-4 col-md-12">
                <div class="main-info-contact-network">
                  <div class="main-info-contact-network-text">
                    Сеть специализированных техцентров по ремонту Вариаторов Mitsubishi Outlander Автоматик-Москва.
        ...
        <div class="container">
          ...
          <div class="main-margin">
            ...
            <ul>
              ...
              <li>   Дмитровское шоссе д.62 (ст.м. Селигерская);</li>
...
-->
      ...
      <div class="footer-avtomatic">Автоматик-Москва: ремонт Вариаторов Mitsubishi Outlander 1997 - 2023</div>
    </div>
...
<!-- скрипт для скрытия Яндекс.Метрики и Google Analytics от ботов! 1-ЫЙ ВАРИАНТ -->
<!-- <div class="site-row">
    <div class="site-popup-inner welcome-pt-message" style="display: none;">
        <form method="post" enctype="multipart/form-data" action="">
            <div class="site-form-title">Добро пожаловать</div>
