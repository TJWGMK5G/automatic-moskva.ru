    ...
    <header class="header">
      <div class="container">
        ...
        <div class="main-content-info">
          <div class="main-content-info-title">Ремонт АКПП, Вариаторов и DSG </div>
          <div class="row">
...
-->
     ...
     <div class="main-content-info-title">Сеть автосервисов по ремонту АКПП, Вариаторов и DSG </div>
      <div class="main-info">
        <div class="container">
