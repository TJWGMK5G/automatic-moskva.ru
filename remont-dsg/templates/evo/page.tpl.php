    ...
    <header class="header">
      <div class="container">
        ...
        <div class="main-content-info">
          <div class="main-content-info-title">Ремонт DSG </div>
          <div class="row">
...
-->
                ...
                <div class="main-content-info-display-bottom">
                  ...
                  <a class="applechat"
                    onclick="yaCounter23396941.reachGoal('social'); ga('send', 'event', 'request', 'social');" href="https://bcrw.apple.com/sms:open?service=iMessage&recipient=urn:biz:5e6cadc4-da68-451c-b6e9-f6eaac913b48" target="_blank"><img
                      alt="Ремонт DSG" src="../templates/evo/images/Icon/ime.png" /></a>
                </div>
     ...
     <div class="main-content-info-title">Сеть автосервисов по ремонту DSG </div>
      <div class="main-info">
        <div class="container">
              ...
              <div class="col-4 col-md-12">
                <div class="main-info-contact-network">
                  <div class="main-info-contact-network-text">
                    Сеть специализированных техцентров по ремонту DSG Автоматик-Москва.
...
-->
      ...
      <div class="footer-avtomatic">Автоматик-Москва: ремонт DSG 1997 - 2023</div>
    </div>
